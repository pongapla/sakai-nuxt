...
watch(
    () => [modelRef.userName, modelRef.password],
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    ...
                    <div>
                        <div>
                            ...
                            <InputText id="userName" v-model="modelRef.userName" type="text" placeholder="Username" class="w-full md:w-30rem mb-2" style="padding: 1rem" />
                            <small v-if="errorMessages.userName" class="p-error block">{{ errorMessages.userName }}</small>
                        </div>

                        <div>
                            <label for="password1" class="block text-900 font-medium text-xl mb-2">Password</label>
                            <Password v-model="modelRef.password" placeholder="Password" :toggleMask="true" class="w-full mb-3" inputClass="w-full" :inputStyle="{ padding: '1rem' }" :feedback="false" variant="filled"> </Password>
                            <small v-if="errorMessages.password" class="p-error block">{{ errorMessages.password }}</small>
                        </div>
